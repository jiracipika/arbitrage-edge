...
export default function Strategy() {
  ...
  const [active, setActive] = useState(state.config.strategy);
  const [paperTrading, setPaperTrading] = useState(state.config.paperTrading);
  const [aiAgent, setAiAgent] = useState<'claude' | 'glm' | 'manual'>(state.config.aiAgent);
  ...
  const backtestData = [
    { date: 'W1', value: 10200 }, { date: 'W2', value: 10450 }, { date: 'W3', value: 10380 },
    { date: 'W4', value: 10720 }, { date: 'W5', value: 10650 }, { date: 'W6', value: 11080 },
    { date: 'W7', value: 10920 }, { date: 'W8', value: 11450 }, { date: 'W9', value: 11210 },
    { date: 'W10', value: 11890 }, { date: 'W11', value: 11650 }, { date: 'W12', value: 12340 },
  ];
            ...
            <div style={{ ...card, background: 'linear-gradient(135deg, #007aff, #5856d6)', color: '#fff' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                  ...
                  <div style={{ fontSize: 13, opacity: 0.8, marginTop: 4 }}>{paperTrading ? '📝 Paper Mode' : '🔴 LIVE'} • {aiAgent.toUpperCase()}</div>
                </div>
                <div style={{ textAlign: 'right' }}>
                  <div style={{ fontSize: 12, fontWeight: 500, opacity: 0.8 }}>Session</div>
