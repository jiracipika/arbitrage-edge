...
import { fetchBTCPrice, fetchPolymarketCrypto, detectArbitrage, formatUSD, type BTCPrice, type ArbOpportunity } from '../_api';
  ...
  return (
    <div>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: 24 }}>
        ...
        <div style={{ padding: 20, borderRadius: 16, background: 'var(--ios-bg2)', boxShadow: 'var(--ios-shadow)', display: 'flex', gap: 16, marginBottom: 20 }}>
          <div style={{ flex: 1 }}>
        ...
        {loading ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {filtered.map(o => (
              <div key={o.id} onClick={() => setDetail(detail === o.id ? null : o.id)} style={{
                ...
                <div style={{ display: 'flex', gap: 16, marginTop: 8 }}>
                  <div><span style={{ fontSize: 12, color: 'var(--ios-label3)' }}>Spot</span><br /><span style={{ fontSize: 14, fontWeight: 600 }}>{formatUSD(o.spotPrice)}</span></div>
                ...
                {detail === o.id && (
                  <div style={{ marginTop: 16, padding: 16, borderRadius: 12, background: 'var(--ios-bg)' }}>
                    <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 6 }}>AI Reasoning</div>
                    ...
                    <div style={{ display: 'flex', gap: 8 }}>
                      ...
                      <a href={o.polymarketUrl} target="_blank" rel="noopener noreferrer" style={{ padding: '8px 20px', borderRadius: 10, fontSize: 13, fontWeight: 600, border: '1px solid var(--ios-separator)', background: 'var(--ios-bg2)', color: 'var(--ios-label)' }}>View on Polymarket</a>
                    </div>
                  </div>
                )}
              </div>
