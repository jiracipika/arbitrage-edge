...
const STRATEGY_COMPARE = [
  { name: 'Lag Arb', pnl: 4210, winRate: 78, sharpe: 2.1 },
  { name: 'Mean Rev', pnl: 1890, winRate: 71, sharpe: 1.8 },
  { name: 'Momentum', pnl: 2870, winRate: 62, sharpe: 1.5 },
];
  ...
  return (
    <div>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: 24 }}>
        ...
        <p style={{ fontSize: 15, color: 'var(--ios-label3)', marginBottom: 24 }}>Performance insights and strategy metrics.</p>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12, marginBottom: 20 }}>
          {[
            { label: 'Total P&L', value: `$${totalPnl.toFixed(2)}`, color: 'var(--ios-green)' },
            ...
            <div key={i} style={card}>
              <div style={{ fontSize: 12, color: 'var(--ios-label3)', marginBottom: 4 }}>{m.label}</div>
          ...
          <div style={card}>
            ...
            <ResponsiveContainer width="100%" height={220}>
              <AreaChart data={MOCK_ANALYTICS_PNL}>
                <defs><linearGradient id="pnlG" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#34c759" stopOpacity="0.2" /><stop offset="100%" stopColor="#34c759" stopOpacity="0" /></linearGradient></defs>
                ...
                <Area type="monotone" dataKey="pnl" stroke="#34c759" strokeWidth="2" fill="url(#pnlG)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
          <div style={card}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
          <div style={card}>
            ...
            <div style={{ fontSize: 12, color: 'var(--ios-label3)', marginTop: 4 }}>{best.strategy} &middot; {best.exitTime}</div>
          </div>
          <div style={card}>
            ...
            <div style={{ fontSize: 12, color: 'var(--ios-label3)', marginTop: 4 }}>{worst.strategy} &middot; {worst.exitTime}</div>
          </div>
        </div>
      </div>
    </div>
